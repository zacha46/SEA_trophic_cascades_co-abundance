...
## 14 cams per SU was causing probelms earlier... 
# how many SUs do we lose by exclusing them?
nrow(meta[meta$cell_id_3km %in% meta$cell_id_3km[meta$cams_included_count >= 14],]) / nrow(meta) * 100
# 1% of SUs, thats fine. 
...
# write.csv(traits, here::here("results/clean_72_species_trait_data_20230615.csv"), row.names = F)
