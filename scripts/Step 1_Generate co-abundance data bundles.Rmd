...
setdiff(caps$cell_id_3km, meta$cell_id_3km) # full match, good to go! 
...
meta = select(meta, cell_id_3km, survey_id, Landscape, source, cams_included_count, year, 
              Avg_altitude_3km, Avg_human_footprint_3km, Avg_FLLI_3km)

### and do the same for caps
caps = select(caps, cell_id_3km, survey_id, seq, Date, num_cams_active_at_date, Species, total_indiv_records, independent_events)
...
# saveRDS(keep, paste("data_GitHub/species_vector_", length(keep), "_species_", date, ".RDS", sep = ""))
# 
# saveRDS(group_sp, paste("data_GitHub/group_living_", length(group_sp), "_species_", date, ".RDS", sep = ""))
# 
# write.csv(caps, paste("data_GitHub/clean_captures_to_make_UMFs_", date,".csv", sep = ""), row.names = F)
# 
# write.csv(meta, paste("data_GitHub/clean_metadata_to_make_UMFs_", date,".csv", sep = ""), row.names = F)
# 
...
# keep = readRDS("data_GitHub/species_vector_44_species_20240228.RDS")
# group_sp = readRDS("data_GitHub/group_living_8_species_20240228.RDS")
# caps = read.csv("data_GitHub/clean_captures_to_make_UMFs_20240228.csv")
# meta = read.csv("data_GitHub/clean_metadata_to_make_UMFs_20240228.csv")
# traits = read.csv("data_Github/clean_44_species_trait_data_20240228.csv")
