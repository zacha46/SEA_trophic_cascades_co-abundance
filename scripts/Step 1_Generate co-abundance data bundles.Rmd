...
sort(names(umfs)) # looks good, except one typo b/c long species name
...
length(bdata_list) #394 combos after removing species that don't spatially overlap --> Nice! should allow faster testing as we reduce species. 
