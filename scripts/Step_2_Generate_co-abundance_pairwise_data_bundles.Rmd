...
# which species
sort(res$species[res$max_count > 20]) # lots of group living species, no predators except dhole (makes sense), 18 sp
sort(res$species[res$max_count > 25]) # 13 species
sort(res$species[res$max_count > 30]) # 11 species

## set the maximum to 25 
cap_max = 25
cap_sp = sort(res$species[res$max_count > 25])
