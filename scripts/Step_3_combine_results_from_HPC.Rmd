...
files = list.files(paste(getwd(),"/data_CoA_bundles/", sep = ""))
...
for(i in 1:length(files)){
  ...
  b = readRDS(paste(getwd(),"/data_CoA_bundles/", files[i], sep = ""))
...
cf_data_files = list.files("data_CoA_bundles/counterfactual_testing/") # update for github 
## remove old files
...
for(i in 1:length(cf_data_files)){
  ...
  path = paste("data_CoA_bundles/counterfactual_testing/", cf_data_files[i], sep = "")
  # import
  dat = readRDS(path)
  # grab the names
  sp = names(dat)
