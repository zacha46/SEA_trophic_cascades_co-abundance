...
# options are "Jan_2024", "Sep_2024" "Oct2024", "Dec2024", "June_2025", "July_2025", "September_2025", and "Oct2025"
time = "Dec2024"
...
#load guild data
guilds = read.csv(paste(import_legacy_dat_path, "clean_44_species_trait_data_20250306.csv", sep = ""))
...
wd = bundle_path
cf_data_files = list.files(wd, recursive = T)
...
for(i in 1:length(cf_data_files)){
  ...
  df = cf_mods[0,]
  # make a path
  path = paste(wd, cf_data_files[i], sep = "")
  # import
  dat = readRDS(path)
  # grab the names
  sp = names(dat)
