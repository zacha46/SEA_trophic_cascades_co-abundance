...
### Inspect which species pairs are present/missing, 20241021, LONG settings
setdiff(all_combos, coeff$Species_Pair) 
## 91 models still running on the HPC, replace w/ middle settings 
...
str(preform[preform$mod_completion == "uncompleted",]) # all NA 
...
## specify the MCMC setting were interested in 
setting = "MIDDLE"
# LONG is still running/may take forever
