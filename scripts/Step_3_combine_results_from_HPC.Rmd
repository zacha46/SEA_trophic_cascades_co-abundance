...
wd = paste("/Users/zachary_amir/Dropbox/Zach PhD/Ch3 Trophic release project/SEA_TC_GitHub_data_storage/data/step1_output/")
# wd = paste(getwd(), "/data_GitHub/", sep = "") # update for github
...
for(i in 1:length(files)){
  ...
  # import
  b = readRDS(paste(wd, "step2_output_CoA_bundles/", files[i], sep = ""))
  # b = readRDS(paste(getwd(),"/data_CoA_bundles/", files[i], sep = "")) # update for GitHub
...
# wd = paste(getwd(), "/results_final/", sep = "") # update for github
...
guilds = read.csv("data_GitHub/clean_44_species_trait_data_20250306.csv") # update for github 
