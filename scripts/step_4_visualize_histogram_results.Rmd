...
plot_dat_mod$support = factor(plot_dat_mod$support, levels = c("top-down", "bottom-up", "unsupported_1", "unsupported_2","unsupported_3"))
plot_dat_mod$support_conserv = factor(plot_dat_mod$support_conserv, levels = c("top-down", "bottom-up", "unsupported_1","unsupported_2","unsupported_3"))
