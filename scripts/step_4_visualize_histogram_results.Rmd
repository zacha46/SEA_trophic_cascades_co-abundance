...
sum_table_cf$percent[sum_table_cf$counter_factual_test == "site_matching_ThaiEFC"] = round(sum_table_cf$num_lvl[sum_table_cf$counter_factual_test == "site_matching_ThaiEFC"] / length(ppc_values_cf$counter_factual_test[ppc_values_cf$counter_factual_test == "site_matching_ThaiEFC"]) * 100, 1)
...
# sum_table_cf$percent[sum_table_cf$counter_factual_test == "remove_community_detections"] = round(sum_table_cf$num_lvl[sum_table_cf$counter_factual_test == "remove_community_detections"] / length(ppc_values_cf$counter_factual_test[ppc_values_cf$counter_factual_test == "remove_community_detections"]) * 100, 1)
