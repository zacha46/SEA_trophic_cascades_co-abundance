...
if(github){
  ...
  save_fig_path = "~/GitHub Repositories/SEA_trophic_cascades_co-abundance/figures/step5_output_forest_plot/"
}else{
  ...
  save_fig_path = "~/Dropbox/Zach PhD/Ch3 Trophic release project/SEA_TC_GitHub_data_storage/figures/step5_output_forest_plot/"
}
...
## finally, dont forget to save the data used to make the plot! 
dat$support_conserv = NULL
dat$guild_pair = NULL
dat$MCMC_setting = NULL
dat$preference = NULL # only preferred
path = paste(wd, "meta-regression_raw_covariates_to_share_", date, ".csv", sep = "")
# write.csv(dat, path, row.names = F)
